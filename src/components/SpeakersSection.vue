...
const speakers = [
  ...
  },
  {
    ...
    name: 'Екатерина Суровцева',
    role: 'Основатель бренда «TWO KEI»',
  },
  {
    image: '/speaker_15.png',
    name: 'Татьяна Стафеева',
    role: 'Представитель сети клиник «Labroom» по связям с общественностью',
  },
  {
    image: '/speaker_16.png',
    name: 'Светлана Усатова',
    role: 'Провизор, менеджер компетенций "Фармацевтика" и "Индивидуальные фармацевтические решения" Чемпионата "Профессионалы"',
  },
  {
    image: '/speaker_17.png',
    name: 'Кирилл Мусохранов',
    role: 'Индивидуальный предприниматель, руководитель гончарной школы «TEXTURA» г. Сургут',
  },
  {
    image: '/speaker_18.png',
    name: 'Дилара Коршкова',
    role: 'Руководитель АНО Оздоровительно-досуговый центр "Активная жизнь"',
  },
  {
    image: '/speaker_19.png',
    name: 'Ян Бобаренко',
    role: 'Владелец гончарной школы "Колокол"',
  },
  {
    image: '/speaker_20.png',
    name: 'Елена Матвеева',
    role: 'Руководитель проектов по работе с партнерами Югорского отделения ПАО Сбербанк',
  },
  {
    image: '/speaker_21.png',
    name: 'Бахеддин Алиев',
    role: 'Руководитель АНО Оздоровительно-досуговый центр "Активная жизнь"',
  },
  ...Array.from({ length: 3 }, () => ({
